...
export const bifrost: Theme = {
  ...
  colors: {
    ...
    segments: {
      ...
      ratelimit: { bg: '#1a1127', fg: '#f85149' },
      agent: { bg: '#0d1f2d', fg: '#a371f7' },
      tasks: { bg: '#0d1f2d', fg: '#56d4c8' },
      subagents: { bg: '#1a1127', fg: '#a371f7' },
      block: { bg: '#1a1127', fg: '#c9d1d9' },
      daily: { bg: '#161b22', fg: '#d29922' },
      diff: { bg: '#0d1f2d', fg: '#56d4c8' },
      metrics: { bg: '#0d1f2d', fg: '#56d4c8' },
      sparkline: { bg: '#1a1127', fg: '#a371f7' },
      activity: { bg: '#161b22', fg: '#484f58' },
