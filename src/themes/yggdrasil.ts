...
export const yggdrasil: Theme = {
  ...
  colors: {
    ...
    segments: {
      ...
      ratelimit: { bg: '#2a2318', fg: '#c44b3f' },
      agent: { bg: '#1f2a1a', fg: '#d4a847' },
      tasks: { bg: '#1f2a1a', fg: '#7c9a5e' },
      subagents: { bg: '#2a2318', fg: '#d4a847' },
      block: { bg: '#2a2318', fg: '#d4c9b8' },
      daily: { bg: '#2e261f', fg: '#b89a4a' },
      diff: { bg: '#1f2a1a', fg: '#7c9a5e' },
      metrics: { bg: '#1f2a1a', fg: '#7c9a5e' },
      sparkline: { bg: '#2a2318', fg: '#8aad6a' },
      activity: { bg: '#2e261f', fg: '#6b5f50' },
