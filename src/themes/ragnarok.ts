...
export const ragnarok: Theme = {
  ...
  colors: {
    ...
    segments: {
      ...
      ratelimit: { bg: '#241412', fg: '#c9352d' },
      agent: { bg: '#2a1c18', fg: '#e8a834' },
      tasks: { bg: '#241412', fg: '#8ab65e' },
      subagents: { bg: '#2a1c18', fg: '#e8a834' },
      block: { bg: '#241412', fg: '#e8d5c4' },
      daily: { bg: '#2a1c18', fg: '#e8a834' },
      diff: { bg: '#241412', fg: '#8ab65e' },
      metrics: { bg: '#241412', fg: '#e88a5e' },
      sparkline: { bg: '#2a1c18', fg: '#e8653a' },
      activity: { bg: '#241412', fg: '#6b4f42' },
