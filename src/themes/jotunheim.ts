...
export const jotunheim: Theme = {
  ...
  colors: {
    ...
    segments: {
      ...
      ratelimit: { bg: '#0a2035', fg: '#d45858' },
      agent: { bg: '#122240', fg: '#d4aa4e' },
      tasks: { bg: '#0a2035', fg: '#5eb89a' },
      subagents: { bg: '#122240', fg: '#d4aa4e' },
      block: { bg: '#0a2035', fg: '#e3eaf2' },
      daily: { bg: '#122240', fg: '#d4aa4e' },
      diff: { bg: '#0a2035', fg: '#5eb89a' },
      metrics: { bg: '#0a2035', fg: '#4ec9d4' },
      sparkline: { bg: '#122240', fg: '#8aaff0' },
      activity: { bg: '#0a2035', fg: '#3a506b' },
