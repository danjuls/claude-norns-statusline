...
export interface ThemeColors {
  ...
  segments: {
    ...
    ratelimit: { bg: string; fg: string };
    agent: { bg: string; fg: string };
    block: { bg: string; fg: string };
    daily: { bg: string; fg: string };
    diff: { bg: string; fg: string };
    metrics: { bg: string; fg: string };
    sparkline: { bg: string; fg: string };
    activity: { bg: string; fg: string };
...
export interface Config {
  ...
  segments: {
    ...
    usage: SegmentConfig;
    ratelimit: SegmentConfig;
    agent: SegmentConfig;
    block: SegmentConfig;
    daily: SegmentConfig;
    diff: SegmentConfig;
    metrics: SegmentConfig;
    sparkline: SegmentConfig;
    activity: SegmentConfig;
