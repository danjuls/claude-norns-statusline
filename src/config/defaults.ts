...
export const DEFAULT_CONFIG: Config = {
  ...
  segments: {
    ...
    ratelimit: { enabled: false, priority: 65 },
    agent: { enabled: false, priority: 55 },
    tasks: { enabled: false, priority: 52 },
    subagents: { enabled: false, priority: 51 },
    block: { enabled: false, priority: 50 },
    daily: { enabled: false, priority: 45 },
    diff: { enabled: false, priority: 35 },
    metrics: { enabled: false, priority: 40 },
    sparkline: { enabled: false, priority: 25 },
    activity: { enabled: false, priority: 15 },
